...
export interface OrderedListNode { type: 'ordered-list-item'; items: ConversationLine[][]; start?: number }
export interface UnorderedListNode { type: 'unordered-list-item'; items: ConversationLine[][] }

    ...
    return (
        ...
        >
            ...
            <div className="ce-dialog-footer">
                <button className="ce-button ce-button-green ce-button-strong" onClick={() => onOpenChange(false)}>{t('Save')}</button>
            </div>
            <button className="ce-icon-button ce-close-button" aria-label="Close" onClick={() => onOpenChange(false)}>
                <IconCross />
            </button>
        </Dialog>
    )

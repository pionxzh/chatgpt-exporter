...
export function IconJSON() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="ce-icon-md" style={{ marginInline: '-2px', marginTop: '2px' }} stroke-width="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
...
export function IconPDF() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="ce-icon-lg" style={{ marginInline: '-4px', marginTop: '2px' }} stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
export function IconZip() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="ce-icon" stroke-width="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
...
export function IconLoading({ className, style }: { className?: string, style?: React.CSSProperties }) {
    return (
        <span style={{ display: 'inline-flex', animation: '1.4s linear 0s infinite normal none running ce-rotate' }}>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="22 22 44 44"
                className={className}
                style={{ animation: '1.4s ease-in-out 0s infinite normal none running ce-circular-dash', ...style }}
                fill="none"
                stroke="currentColor"
                stroke-width="2"
            >
